...
OBJS_PLY := $(patsubst $(PLY_DIR)/%.cpp, $(BUILD_DIR)/%.o, $(SRCS_PLY))
...
$(EXEP) : $(OBJS_PLY) $(OBJS_ENG)
	$(CXX) $(OBJS_PLY) $(OBJS_ENG) -o $(EXEP)
...
$(BUILD_DIR)/%.o: $(PLY_DIR)/%.cpp
	$(CXX) $(INCLUDE_ENGINE) $(CXX_FLAGS) $(PLY_DIR)/$*.cpp -o $@
